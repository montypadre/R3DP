...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'r3dp_test_server_DB_7745c7842bf48b9d6231_20181222215227_archive.zip';
	const ARCHIVE_SIZE		 = '338017';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '7745c78-22215227';
	const VERSION			 = '1.3.0';
