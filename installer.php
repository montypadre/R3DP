...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'r3dp_localhost_DB_Mike_969e8869edc47dde3383_20190119041610_archive.zip';
	const ARCHIVE_SIZE		 = '353107';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '969e886-19041610';
	const VERSION			 = '1.3.4';
