...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'r3dp_localhost_DB_Mike_57ae92baf5daafd87617_20181230001033_archive.zip';
	const ARCHIVE_SIZE		 = '335774';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '57ae92b-30001033';
	const VERSION			 = '1.3.0';
