...
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	require_once trailingslashit( get_template_directory()).'admin/redux-extensions/extensions/wbc_importer/inc/importer/radium-importer.php'; //load admin theme data importer
