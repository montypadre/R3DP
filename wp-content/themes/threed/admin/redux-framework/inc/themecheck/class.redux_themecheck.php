<?php
    ...
    if ( ! class_exists( 'Redux_ThemeCheck' ) ) {
        class Redux_ThemeCheck {
             ...
             * @since    1.0.0
             */
            ///opt/lampp/htdocs/threed-businessthemes/wp-content/themes/threed/admin/redux-framework/inc/themecheck/class.redux_themecheck.php
            function add_checks() {
                global $themechecks;

                // load all the checks in the checks directory
                $dir = 'checks';
                foreach ( glob( trailingslashit( get_template_directory() ).'admin/redux-framework/inc/themecheck/' . $dir . '/*.php' ) as $file ) {
                    require_once $file;
                }
            }
