    ...
    if ( ! class_exists( 'ReduxFramework_extension_customizer' ) ) {
        ...
        class ReduxFramework_extension_customizer {
            ...
            public function __construct( $parent ) {
                ...
                ///opt/lampp/htdocs/threed-businessthemes/wp-content/themes/threed/admin/redux-framework/inc/extensions/customizer/extension_customizer.php

                if ( empty( $this->_extension_dir ) ) {
                    $this->_extension_dir = trailingslashit( str_replace( '\\', '/', trailingslashit( get_template_directory() ).'admin/redux-framework/inc/extensions/customizer/' ) );
            ...
            public function _register_customizer_controls( $wp_customize ) {
                ...
                if ( ! class_exists( 'Redux_Customizer_Section' ) ) {
                    include_once trailingslashit( get_template_directory() ).'admin/redux-framework/inc/customizer_section.php';
                    if ( method_exists( $wp_customize, 'register_section_type' ) ) {
                        $wp_customize->register_section_type( 'Redux_Customizer_Section' );
                    }
                }
                if ( ! class_exists( 'Redux_Customizer_Panel' ) ) {
                    include_once trailingslashit( get_template_directory() ).'admin/redux-framework/inc/customizer_panel.php';
                ...
                if ( ! class_exists( 'Redux_Customizer_Control' ) ) {
                    include_once trailingslashit( get_template_directory() ).'admin/redux-framework/inc/customizer_control.php';
                }

                include_once trailingslashit( get_template_directory() ).'admin/redux-framework/inc/customizer_fields.php';
                include_once trailingslashit( get_template_directory() ).'admin/redux-framework/inc/customizer_devs.php';
            ...
            public function _enqueue_previewer() {
                ...
                $localize = array(
                    'save_pending'   => __( 'You have changes that are not saved. Would you like to save them now?', 'threed' ),
                    'reset_confirm'  => __( 'Are you sure? Resetting will lose all custom values.', 'threed' ),
                    'preset_confirm' => __( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'threed' ),
