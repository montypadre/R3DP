    ...
    if ( ! class_exists( 'ReduxFramework_extension_import_export' ) ) {
        ...
        class ReduxFramework_extension_import_export {
            ...
            public function overload_field_path( $field ) {
                return trailingslashit( get_template_directory() ).'admin/redux-framework/inc/extensions/import_export/' . $this->field_name . '/field_' . $this->field_name . '.php';
            }
