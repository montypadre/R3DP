        ...
        class ReduxFramework_Extension_options_object {
            ...
            public function add_section() {
                $this->parent->sections[] = array(
                    'id' => 'options-object',
                    'title' => __( 'Options Object', 'threed' ),
                    'heading' => '',
            ...
            public function overload_field_path( $field ) {
                return trailingslashit( get_template_directory() ).'admin/redux-framework/inc/extensions/options_object/' . $this->field_name . '/field_' . $this->field_name . '.php';
            }
        } // class
    } // if
